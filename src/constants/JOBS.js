...
module.exports = [
  ...
  },
  {
    ...
    fields: [
      {
        placeholder: "Model lub nazwa przedmiotu",
        type: FIELD_TYPES.textarea,
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder:
          "wpisz produkty i ilość, lub zrób zdjęcie listy zakupów i wprowadź",
        type: FIELD_TYPES.textarea,
      },
    ],
  },
  {
    ...
    color: "#ff0064",
    photoURL: "https://s3-eu-west-1.amazonaws.com/helpio/jobs/barman.png",
    fields: [
      {
    ...
    fields: [
      {
        label: "Rodzaj pomieszczenia",
        id: "hNFsaQQJgwA7kVjoQG8ec",
        options: ["Relaksacyjny", "Rehabilitacyjny", "Sportowy", "Inny"],
        placeholder: "",
        type: FIELD_TYPES.select,
      },
      {
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        showIf: "Miejsce",
        options: ["Odbiór własny", "Dostawa pod adres"],
    ...
    fields: [
      {
        ...
        placeholder:
          "Szczegóły (ciąganie poprzedniej powłoki, malowanie (proste, artystyczne itp.)",
        type: FIELD_TYPES.textarea,
      },
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder:
          "Zakres czynności (rozkładanie i ściąganie naczyń / posiłków / nakładanie / rozlewanie posiłków / mycie naczyń, itp.)",
        type: FIELD_TYPES.textarea,
      },
  ...
  {
    id: "nrBGrxgfWEYNXCM9vBoT",
    name: "Naprawa samochodu",
    color: "#ff0064",
    photoURL:
      "https://s3-eu-west-1.amazonaws.com/helpio/jobs/naprawa-samochodu.png",
    fields: [
      {
        id: "3RNuTgF9v5DhVFqLD6sZ",
        placeholder: "Marka i modela",
        type: FIELD_TYPES.textarea,
      },
      {
        id: "bRezUr8PtV8VcmQv3V5W",
        options: ["Na miejscu", "Odstawię pod adres"],
        type: FIELD_TYPES.multiRadio,
      },
      {
        id: "tdp6XD2qZvMQ3S2FMqoc",
        showBy: "bRezUr8PtV8VcmQv3V5W",
        showIf: "Na miejscu",
        placeholder: "Miejsce gdzie samochód będzie do odbioru",
        type: FIELD_TYPES.textarea,
      },
      {
        id: "3zgrKK4CcxdYQqHfAhtd",
        label: "Typ pojazdu",
        options: ["mechaniczna", "elektryczna", "silnik", "koła", "inne"],
        placeholder: "",
        type: FIELD_TYPES.select,
      },
      {
        id: "L3xSzHXhvVSXVzN6Jh8n",
        placeholder: "Opisz awarię",
        showBy: "3zgrKK4CcxdYQqHfAhtd",
        showIf: "inne",
        type: FIELD_TYPES.select,
      },
      FIELDS.hourlySettlement("NuD9tSDCzcpdpz8qSGtS"),
      FIELDS.provideTools("gMb9vNUwvHvPm9WXmTSD"),
      FIELDS.provideResources("AJB9moTEZCZJow56KcZN"),
      FIELDS.additionalInfo("TddGcLxuSqMsXgVafh87"),
    ],
  },
];
